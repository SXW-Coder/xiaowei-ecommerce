...
export default async function Page({ params }: { params: Promise<{ id: string }> }) { 
    ...
    return (
        <div className="container flex py-6">
            ...
            <div className="h-screen flex-1 mx-10 bg-slate-50 p-4 rounded-lg shadow-md relative">
                <Image  src={product.image} alt={product.name} fill priority  style={{objectFit:'contain'}}/>
            </div>
